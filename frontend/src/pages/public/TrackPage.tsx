                                    ...
                                    <div className="card">
                                        ...
                                        <dl className="space-y-3 text-sm">
                                            {[
                                                ...
                                                { label: 'Transport Mode', value: shipment.transportMode ? shipment.transportMode.charAt(0).toUpperCase() + shipment.transportMode.slice(1) : 'Land' },
                                                { label: 'Pet Shipping', value: shipment.containsPets ? 'Yes' : 'No' },
